...
/**
 * Function Name: videocast_save_comment_rating
 ...
 */
function videocast_save_comment_rating($comment_id = 0) {
...
add_action('wp_insert_comment', 'videocast_save_comment_rating');
/**
 * Function Name: videocast_del_comment_rating
 ...
 * @param type $comment_id 
 */
function videocast_del_comment_rating($comment_id = 0)
{
...
add_action( 'wp_delete_comment', 'videocast_del_comment_rating' );
/**
 * Function Name: videocast_draw_rating_star
 ...
 * @return string 
 */
function videocast_display_rating_star($avg_rating) {
...
/**
 * Function Name: videocast_get_rating
...
/**
 * Function Name: videocast_get_post_average_rating
 ...
 * @return type 
 */
function videocast_get_post_average_rating($pid)
{
...
/**
 * Function Name: videocast_get_post_rating_star
 * Description: Display rating in post
 * @param type $pid
 * @return type 
 */
function videocast_get_post_rating_star($pid='')
{
	$rtn_str = '';
	$avg_rating = videocast_get_post_average_rating($pid);
	$rtn_str = videocast_display_rating_star($avg_rating);
	return $rtn_str;
}
/**
 * Function Name: videocast_is_user_can_add_comment
 ...
 * @return type 
 */
function videocast_is_user_can_add_comment($pid)
{
