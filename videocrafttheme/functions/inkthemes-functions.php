...
function inkthemes_register_custom_menu1() {
    register_nav_menu('custom_menu_footer', __('Footer Menu', 'inkthemes_blogtrend'));
}
...
add_action('videocast_auth_menu', 'videocast_auth_menu');
/* ----------------------------------------------------------------------------------- */
/* Show analytics code in footer */
/* ----------------------------------------------------------------------------------- */
...
function insert_listing_data($post_data) {
    ...
    $subject = 'A New Video has been Submitted';
    $message = "A New Video has been Submitted by " . $current_user->user_login . " on your website:\n\n user Email Id Is " . $current_user->user_email;
...
function videocast_submit_video() {
...
//End Post 5
    ...
    if (isset($_POST['submit'])) {
        if (inkthemes_get_option('video_post_mode') == 'Pending') {
            echo "<div class='sucess-send'><h2>Your Video has been successfully submitted And Awaiting For Publish.				
</h2>  </div>
";
            ?>
            <br/>
            ...
            echo "<div class='sucess-send'><h2>Your Video has been Publish.				
</h2>  </div> ";
        }
        ?>
        <br/>
...
// Is the Response
    ...
    if (isset($_FILES['data']) && ($_FILES['data']['size'] > 0)) {
        ...
        $allowed_file_types = array('image/jpg', 'image/jpeg', 'image/gif', 'image/png', 'video/mp4', 'video/x-flv', 'video/mov');
        ...
        if (in_array($uploaded_file_type, $allowed_file_types)) {
            ...
            if (!empty($uploaded_file['error'])) {
                ...
                $return_fields['message'] = "Uploaded sucessfully.";
            }
