...
class video_category_search extends WP_Widget {
	...
	function video_category_search() {
		parent::WP_Widget( 'video_category_search', $name = 'Video Search' );
	}
	/**
	* This is the Widget
	**/
    ...
    <div>
	   <input type="text" onfocus="if (this.value == '<?php echo $title; ?>') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php echo $title; ?>';}"  value="<?php echo $title; ?>" name="s" id="s" />
