...
foreach($query as $rows){
	?>
	 ...
	 <span class="author"><?php $user=get_userdata($rows->post_author);
			...
			<span class="views"><?php echo getPostViews($rows->ID); ?></span>
				  ...
				  <h6 class="title"><a href="<?php echo get_permalink($rows->ID); ?>" rel="bookmark" title="Permanent Link to <?php echo $rows->post_title; ?>">
                                <?php
                                //$tit = the_title('', '', FALSE);
								$tit = $rows->post_title;
